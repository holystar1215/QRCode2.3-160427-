...
- (void)viewDidLoad {
    ...
    [self setCompletionWithBlock:^(NSString *resultAsString) {
        MAINTHREAD_RUN_BLOCK((^{
            ...
            [[CWebService sharedInstance] manual_code:wSelf.codeInfo pddw:[[CDataSource sharedInstance].loginModel pddw] success:^(NSString *obj, NSInteger code) {
                ...
                switch (code) {
                    ...
                    case 1006: {
                        ...
                        [alertView bk_addButtonWithTitle:@"确定" handler:^{
                            [[CWebService sharedInstance] manual_profit_code:wSelf.codeInfo dlmc:[[CDataSource sharedInstance].loginModel dlmc] pddw:[[CDataSource sharedInstance].loginModel pddw] mc:@"人工" success:^(NSString *msg, NSInteger code) {
                                //TODO:
                    ...
                    case 2000: {
                        if ([[obj substringToCharacter:'@'] isEqualToString:[[CDataSource sharedInstance].loginModel pddw]]) {
                            ...
                            [alertView bk_addButtonWithTitle:@"确定" handler:^{
                                ...
                                [[CWebService sharedInstance] manual_confirm_code:wSelf.codeInfo dlmc:[[CDataSource sharedInstance].loginModel dlmc] pddw:[[CDataSource sharedInstance].loginModel pddw] mc:@"人工" success:^(NSString *msg, NSInteger code) {
                    ...
                    case 2002: {
                        wSelf.infoView.infoLabel.text = obj;
                    ...
                    case 2003: {//对不起,您的优先级小于1,不能二次盘点.
                        wSelf.infoView.infoLabel.text = @"页面上显示 资产不存在";
                        UIAlertView *alertView = [UIAlertView bk_alertViewWithTitle:@"提示" message:@"对不起,您的优先级小于1,不能二次盘点"];
                        [alertView bk_addButtonWithTitle:@"确定" handler:^{
